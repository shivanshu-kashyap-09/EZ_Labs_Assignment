...
import leftBranding from '../../assets/service/left-branding.svg'
import arrow from '../../assets/service/arrow.svg'
import rightTopBranding from '../../assets/service/right-top-branding.svg'
import rightMiddleBranding from '../../assets/service/right-middle-branding.svg'
import rightBottomBranding from '../../assets/service/right-bottom-branding.svg'

const Branding = ({ onMouseLeave }) => {
    return (
        <section className='bg-[rgba(255,157,125,0.7)] h-240 lg:h-170 relative text-center flex items-center flex-col px-4 lg:px-0 py-10 lg:py-10'>
            ...
            <img src={leftBranding} alt="left branding" className='w-[80px] sm:w-[100px] lg:w-[115px] h-[80px] sm:h-[95px] lg:h-[110px] absolute top-[500px] sm:top-[480px] lg:top-[495px] left-[30px] sm:left-[45px] lg:left-[56px]' />
            ...
            <div className='h-auto w-[90%] sm:w-[80%] lg:w-[400px] absolute top-[600px] sm:top-[160px] lg:top-[160px] left-1/2 lg:left-[610px] -translate-x-1/2 lg:translate-x-0 md:top-150'>
                <p className='font-[Instrument_Sans] text-[16px] sm:text-[18px] lg:text-[20px] text-[#252729] text-left leading-relaxed'>
                    ...
                    return to, and fall in love with. <br />
                    V creates: <br />
            ...
            <img src={rightTopBranding} alt="right top Branding" className='hidden lg:block w-[115px] h-[141px] absolute right-20 top-20 md:block md:top-30' />
            <img src={rightMiddleBranding} alt="right middle Branding" className='hidden lg:block w-[115px] h-[141px] absolute lg:left-220 top-80 md:block md:top-90 md:left-140' />
            <img src={rightBottomBranding} alt="right bottom Branding" className='hidden lg:block w-[115px] h-[141px] absolute right-20 lg:top-120 md:block md:top-150' />
        </section>
    )
}
